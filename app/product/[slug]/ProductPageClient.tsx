...
export function ProductPageClient({ product }: ProductPageClientProps) {
  ...
  const getRelatedProducts = () => {
    const otherProducts = productsData.filter((p: any) => p.slug !== product.slug)
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="flex-1 bg-[#131313] text-white px-8 py-4 rounded-full font-medium hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center space-x-2"
                >
